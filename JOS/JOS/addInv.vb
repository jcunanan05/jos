Public Class addInv
    ...
    Public Sub New(ByRef manager_user_name As String)
        ...
        managerUserName = manager_user_name 'initialize manager username
    End Sub
    ...
    Private Sub add_button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles add_button.Click
        ...
        'get value from supplier combobox
        If new_supplier_chbox.Checked Then
            'if new supplier is checked
        ...
        If new_category_chbox.Checked Then
            'if new category is checked
            partCategory = category_combo.Text
        Else
            'if new category is not checked
            partCategory = category_combo.SelectedItem
        End If
        ...
        Dim categoryTaken As Boolean = newItem.categoryTaken(new_category_chbox)
        ...
        If supplierTaken = False Then
            ...
            If categoryTaken = False Then
                'if brand category is not taken
                If itemTaken = False Then
                    'if item has no match in db
                    newItem.addItem(new_supplier_chbox, new_category_chbox)
            ...
            Else
                ...
                MsgBox(newItem.wrongNewCategory)
            End If
    ...
    Private Sub new_category_chbox_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles new_category_chbox.CheckedChanged
        'when new category check box is clicked
        If new_category_chbox.Checked Then
            category_combo.DropDownStyle = ComboBoxStyle.Simple
        Else
            'when not checked
            category_combo.DropDownStyle = ComboBoxStyle.DropDownList
        End If
    End Sub
End Class